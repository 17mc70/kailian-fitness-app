...
void main(List<String> args) async {
  await build(args, (input, output) async {
    ...
    // Android: skip native asset provisioning for sqlite3.
    // sqlite3 is only pulled in by sqflite_common_ffi (dev dependency, tests
    // on desktop). On Android, sqflite provides its own SQLite via Flutter
    // plugin, so we don't need the sqlite3 package to download its binary.
